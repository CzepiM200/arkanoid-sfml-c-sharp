...
{
    class StrongRacket : Racket, IRacketBehaviour
    {
        public StrongRacket(uint x, uint y) : base(x, y)
        {
            lenghtX = 210;
            lenghtY = 32;
        ...
        {
            sprite = new Sprite(DataLoader.racket2, new IntRect(0, 0, (int)lenghtX, (int)lenghtY))
            {
                Texture = { Smooth = true },
